...
namespace TesteNovaVida2.Controllers
{
    public class AlunoesController : Controller
    {
        private readonly TesteNovaVida2Context _context;

        public AlunoesController(TesteNovaVida2Context context)
        {
            _context = context;
        }
        ...
        {
            var testeNovaVida2Context = _context.Aluno.Include(a => a.Professor);
            return View(await testeNovaVida2Context.ToListAsync());
        }
